...
#define PIXMAP_HEIGHT   38
#define PIXMAP_WIDTH    38
...
static void
valueChangedCB_color_pb9(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR9);
}

static void
valueChangedCB_color_pb10(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR10);
}

static void
valueChangedCB_color_pb11(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR11);
}

static void
valueChangedCB_color_pb12(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR12);
}

static void
valueChangedCB_color_pb13(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR13);
}

static void
valueChangedCB_color_pb14(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR14);
}

static void
valueChangedCB_color_pb15(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR15);
}

static void
valueChangedCB_color_pb16(
        Widget w,
        XtPointer clientData,
        XtPointer callbackArg )
{

        Select_New_Pen(COLOR16);
}
...
build_dtIconShell( void )
{
		...
		Dimension     colorButtonSize, padding;
		...
		XtVaGetValues(instructionText, XmNheight, &colorButtonSize,
			XmNpixmapTextPadding, &padding, NULL);
		colorButtonSize += padding * 2;
		...
		XtVaCreateManagedWidget( "staticColorsTitle",
			xmLabelWidgetClass, staticColorsBox, XmNlabelString, tmpXmStr,
        ...
        color_pb1 = XtVaCreateManagedWidget( "color_pb1",
                        ...
                        XmNindicatorOn, FALSE,
                        XmNfillOnSelect, FALSE,
                        XmNwidth, colorButtonSize,
                        XmNheight, colorButtonSize,
                        XmNleftAttachment, XmATTACH_FORM,
                        NULL);
        ...
        color_pb9 = XtVaCreateManagedWidget( "color_pb9",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
                        ...
                        XmNheight, colorButtonSize,
                        XmNleftAttachment, XmATTACH_WIDGET,
                        XmNleftWidget, color_pb8,
                        XmNtopAttachment, XmATTACH_FORM,
                        NULL);

        color_pb10 = XtVaCreateManagedWidget( "color_pb10",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
       ...
       color_pb11 = XtVaCreateManagedWidget( "color_pb11",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
                        ...
                        XmNheight, colorButtonSize,
                        XmNleftAttachment, XmATTACH_WIDGET,
                        XmNleftWidget, color_pb10,
                        XmNtopAttachment, XmATTACH_FORM,
                        NULL);

        color_pb12 = XtVaCreateManagedWidget( "color_pb12",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
       ...
       color_pb13 = XtVaCreateManagedWidget( "color_pb13",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
                        ...
                        XmNheight, colorButtonSize,
                        XmNleftAttachment, XmATTACH_WIDGET,
                        XmNleftWidget, color_pb12,
                        XmNtopAttachment, XmATTACH_FORM,
                        NULL);

        color_pb14 = XtVaCreateManagedWidget( "color_pb14",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
       ...
       color_pb15 = XtVaCreateManagedWidget( "color_pb15",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
                        ...
                        XmNheight, colorButtonSize,
                        XmNleftAttachment, XmATTACH_WIDGET,
                        XmNleftWidget, color_pb14,
                        XmNtopAttachment, XmATTACH_FORM,
                        NULL);

        color_pb16 = XtVaCreateManagedWidget( "color_pb16",
                        xmToggleButtonWidgetClass, stdColorPens,
                        XmNshadowThickness, 2,
                        XmNrecomputeSize, FALSE,
                        XmNlabelType, XmPIXMAP,
		...
		XtVaCreateManagedWidget( "staticGraysTitle",
			xmLabelWidgetClass, staticGreysBox, XmNlabelString, tmpXmStr,
			XmNframeChildType, XmFRAME_TITLE_CHILD, NULL);
        XmStringFree(tmpXmStr);
        ...
        tmpXmStr = GETXMSTR(12,10, "Dynamic");
		XtVaCreateManagedWidget( "dynamicColorsTitle",
			xmLabelWidgetClass, symbolicColorsBox, XmNlabelString, tmpXmStr,
			XmNframeChildType, XmFRAME_TITLE_CHILD, NULL);
        XmStringFree(tmpXmStr);
        ...
        tmpXmStr = GETXMSTR(12,18, "Top Shadow");
        ...
        tmpXmStr = GETXMSTR(12,20, "Bottom Shadow");
        ...
        tmpXmStr = GETXMSTR(12,22, "Selected");
        ...
        tmpXmStr = GETXMSTR(12,24, "None (Transparent)");
        ...
        XtAddCallback(color_pb9, XmNvalueChangedCallback,
                        valueChangedCB_color_pb9, NULL);
        XtAddCallback(color_pb10, XmNvalueChangedCallback,
                        valueChangedCB_color_pb10, NULL);
        XtAddCallback(color_pb11, XmNvalueChangedCallback,
                        valueChangedCB_color_pb11, NULL);
        XtAddCallback(color_pb12, XmNvalueChangedCallback,
                        valueChangedCB_color_pb12, NULL);
        XtAddCallback(color_pb13, XmNvalueChangedCallback,
                        valueChangedCB_color_pb13, NULL);
        XtAddCallback(color_pb14, XmNvalueChangedCallback,
                        valueChangedCB_color_pb14, NULL);
        XtAddCallback(color_pb15, XmNvalueChangedCallback,
                        valueChangedCB_color_pb15, NULL);
        XtAddCallback(color_pb16, XmNvalueChangedCallback,
                        valueChangedCB_color_pb16, NULL);
